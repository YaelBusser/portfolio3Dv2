...
void main() {
  float alpha = 1.0 - smoothstep(0.4995, 0.5005, length(gl_PointCoord - vec2(0.5)));
  
  // Utilisation d'une fonction sinusoidale pour osciller entre 0 et 1
  float factor = 0.5 * (1.0 + sin(uTime * 0.001));
  
  // Utilisation d'une couleur gris (par exemple, RGB(0.5, 0.5, 0.5))
  vec3 color = vec3(0.5);
